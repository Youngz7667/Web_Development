 //Adding variables for win counters
 var x_win = 0
 var o_win = 0

// Function called whenever user tab on any box 
function myfunc() { 
    //sending x_win/o_win variables to win counter
    document.getElementById('oWins').innerHTML = o_win
    document.getElementById('xWins').innerHTML = x_win
    ...
    if ((b1 == 'x' || b1 == 'X') && (b2 == 'x' || 
        ...
        // Increments x_win by 1 - is included in all cases where play X wins    
        x_win++
        b4btn.disabled = true; 
        b5btn.disabled = true; 
        b6btn.disabled = true; 
